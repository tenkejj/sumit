...
readonly SERVER="ubuntu@130.61.35.204"
readonly SSH_KEY="/c/Users/frani/Desktop/studia/ssh-key-2026-06-16 (3).key"
...
if systemctl is-active --quiet sumit; then
  ...
  echo "Usługa sumit nie jest jeszcze włączona — uruchom jednorazową konfigurację z README.md"
fi
EOF
